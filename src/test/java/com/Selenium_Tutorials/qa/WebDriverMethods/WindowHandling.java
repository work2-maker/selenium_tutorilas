...
*/		driver.findElement(By.cssSelector("#sbRegFormWrapper > p > a:nth-child(2)")).click(); 
    ...
    //driver.switchTo().window(ChildWindow);    // If we remove this line then the control remains at the original page/parent page and the below opr is not posssible ....
